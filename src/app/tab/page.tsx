...
export default function NewTab() {
      ...
      <div className='flex flex-col justify-between h-full'>
        ...
        <div className='options grid gap-2 md:gap-4 p-2 grid-cols-2'>
            ...
            question!.options.map((val, i) => {
                return <button 
                    key={i} 
                    className='p-3 z-50 text-lg bg-slate-100 border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700' 
                    value={i} 
  ...
  return (
    <main className={`flex flex-col min-h-screen pt-48 md:px-24 items-center ${vt323.className}`}>
      <div className="block lg:w-1/2 w-full h-96 p-2 md:p-8 bg-slate-100 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        {renderBody()}
      </div>
    </main>
  )
